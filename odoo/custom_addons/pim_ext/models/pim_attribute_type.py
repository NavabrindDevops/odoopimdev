...
class PIMAttributeType(models.Model):
     ...
     def action_select_date(self):
          ...
          return {
               ...
               'view_mode': 'form',
               'target': 'current',
               'context': {'no_breadcrumbs': True, 'default_display_type': 'date', 'default_attribute_types_id': self.id},
          }
     ...
     def action_select_identifier(self):
          ...
          return {
               ...
               'view_mode': 'form',
               'target': 'current',
               'context': {'no_breadcrumbs': True,'default_display_type': 'text', 'default_attribute_types_id': self.id},
          }
     ...
     def action_select_ref_data_multi(self):
          ...
          return {
               ...
               'view_mode': 'form',
               'target': 'current',
               'context': {'no_breadcrumbs': True,'default_display_type': 'price', 'default_attribute_types_id': self.id},
          }

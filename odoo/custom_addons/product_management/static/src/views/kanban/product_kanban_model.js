...
export class ProductKanbanRecord extends Record {
    /**
...
export class ProductKanbanModel extends RelationalModel {
    static Record = ProductKanbanRecord;
    static DynamicRecordList = ProductKanbanDynamicRecordList;
    /*
